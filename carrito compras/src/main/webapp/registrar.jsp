...
<head>
    ...
    <style>
        ...
        .btn-register {
            ...
            border-color: #512da8; /* Color del borde */
        ...
        .btn-register:hover {
            background-color: #4527a0; /* Color de fondo al pasar el mouse */
            border-color: #4527a0; /* Color del borde al pasar el mouse */
        }
                    ...
                    <div class="card-body">
                        ...
                        <form method="post" action="procesarRegistro.jsp">
                            ...
                            <div class="login-link">
                                <p>Ya tengo cuenta <a href="iniciarsesion.jsp">INICIAR SESIÓN</a></p>
                            </div>
                        </form>
                        <%
                            } catch (Exception e) {
